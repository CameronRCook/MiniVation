...
public class HxVolumetricCamera : MonoBehaviour
{
   ...
   // bool warned = false;
    ...
    int GetCamPixelWidth()
    {
        ...
        if (Mycamera.stereoTargetEye != StereoTargetEyeMask.None && Application.isPlaying && UnityEngine.XR.XRSettings.enabled && UnityEngine.XR.XRDevice.isPresent)
        {
            //return UnityEngine.VR.VRSettings.eyeTextureWidth + (Mycamera.stereoTargetEye == StereoTargetEyeMask.Both ? UnityEngine.VR.VRSettings.eyeTextureWidth +  Mathf.CeilToInt(48 * UnityEngine.VR.VRSettings.eyeTextureResolutionScale) : 0);
        }
#endif
